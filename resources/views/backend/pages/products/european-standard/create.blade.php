            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('admin-cms/products/european-standard') }}" class="text-muted">Technologies</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <a href="{{ url('admin-cms/products/european-standard/create') }}" class="text-muted">Create European Standard</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Create European Standard</h3>
                        </div>
                    ...
                    <form action="{{ url('admin-cms/products/european-standard/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
