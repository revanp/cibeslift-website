            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">List Faq</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{ url('admin-cms/products/products/faq/'.$id.'/create') }}" class="btn btn-primary font-weight-bolder">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="dropdown dropdown-inline mr-1"><a href="javascript:;" class="btn btn-sm btn-clean btn-icon" data-toggle="dropdown" aria-expanded="false"><i class="flaticon2-menu-1 icon-2x"></i></a><div class="dropdown-menu dropdown-menu-sm dropdown-menu-right"><ul class="nav nav-hoverable flex-column">
                                                <li class="nav-item"><a class="nav-link" href="{{ url('admin-cms/products/products/faq/'.$id.'/edit/'.$val->productFaqId->id) }}"><i class="flaticon2-edit nav-icon"></i><span class="nav-text">Edit</span></a></li>
                                                <li class="nav-item"><a class="nav-link btn-delete" href="{{ url('admin-cms/products/products/faq/'.$id.'/delete/'.$val->productFaqId->id) }}"><i class="flaticon2-delete nav-icon"></i><span class="nav-text">Delete</span></a></li>
                                            </ul></div>
                                        </td>
                                    </tr>
                                @endforeach
