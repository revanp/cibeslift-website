            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">List Options</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{ url('admin-cms/products/products/customizations/'.$id.'/options/'.$idCustomization.'/create') }}" class="btn btn-primary font-weight-bolder">
