                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{ url('admin-cms/products/categories/features/'.$id.'/create') }}" class="text-muted">Create Feature</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Create Feature</h3>
                        </div>
                    ...
                    <form action="{{ url('admin-cms/products/categories/features/'.$id.'/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="sort" id="" class="form-control @if($errors->has('sort')) is-invalid @endif">
                                        @php
                                            $sortData = !empty(old('sort')) ? old('sort') : '';
                                        @endphp
