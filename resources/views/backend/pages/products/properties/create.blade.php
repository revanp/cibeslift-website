...
@section('content')
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{ url('admin-cms/products/properties/create') }}" class="text-muted">Create Property</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="d-flex flex-column-fluid">
		<div class=" container ">
            <form action="{{ url('admin-cms/products/properties/create') }}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    @csrf
                    <div class="col-md-6">
                        <div class="card card-custom">
                            <div class="card-header">
                                <div class="card-title">
                                    <h3 class="card-label">Create Property</h3>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card card-custom">
                            ...
                            <div class="card-body">
                                <div class="property-box p-5" style="border: 1px dashed #d1d6dd">
                                    <div class="form-group col-md-12">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" role="tab" href="#enValue1Tab">English</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content mb-4" style="display: block !important;">
                                        ...
                                        <div class="tab-pane" id="enValue1Tab" role="tabpanel">
                                            <div class="row mt-5">
                                                <div class="form-group col-md-12">
                                                    <label>Name Value</label>
