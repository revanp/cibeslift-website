    ...
    <div class="d-flex flex-column-fluid">
		<div class=" container ">
            <div class="card card-custom mb-5">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Aftersales Title</h3>
                    </div>
                </div>
                <form action="{{ url('admin-cms/content/about-us/aftersales/create-title') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">List Aftersales</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{ url('admin-cms/content/about-us/aftersales/create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <script>
        $(document).ready(function(){
            $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin-cms/content/about-us/aftersales/datatable') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}"
                    }
        ...
        $(document).on('change', '.btn-activate', function(e){
            ...
            $.ajax({
                url: "{{ url('admin-cms/content/about-us/aftersales/change-status') }}",
                type: 'POST',
                dataType: 'json',
                data: {
                    _method: 'put',
