            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('admin-cms/content/about-us/nation') }}" class="text-muted">Nation</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <a href="{{ url('admin-cms/content/about-us/nation/edit/'.$data['id']) }}" class="text-muted">Edit</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="card card-custom">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <a href="{{ url('admin-cms/content/about-us/nation') }}" class="btn btn-danger font-weight-bolder">
                ...
                <form action="{{ url('admin-cms/content/about-us/nation/edit/'.$data['id']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Link</label>
                                    <input type="text" class="form-control" name="link" placeholder="Enter link" value="{{ $data['link'] ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label>Sort</label>
                                ...
                                <div class="tab-pane {{ $key == 'id' ? 'active' : '' }}" id="{{ $key }}Tab" role="tabpanel">
                                    <div class="row mt-5">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="input[{{ $key }}][name]" placeholder="Enter name" value="{{ $data['nation'][$key]['name'] }}">
                                        </div>
                                    </div>
                                </div>
                            @endforeach
