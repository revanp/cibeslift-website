                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{ url('admin-cms/content/faq/questions/create') }}" class="text-muted">Create Questions</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card card-custom">
                    <div class="card-header">
                        <div class="card-title">
                            ...
                            <h3 class="card-label">Create Questions</h3>
                        </div>
                    ...
                    <form action="{{ url('admin-cms/content/faq/questions/create') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row mb-5">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="id_faq_category_id" class="form-control @if($errors->has('id_faq_category_id')) is-invalid @endif">
                                        ...
                                        @php
                                            $idFaqCategoryId = old('id_faq_category_id');
                                        @endphp
                            ...
                            <div class="tab-content mb-4" style="display: block !important;">
                                <div class="tab-pane active" id="idTab" role="tabpanel">
                                    <div class="row mt-5">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="input[id][description]" rows="5" class="form-control @if($errors->has('input.id.description')) is-invalid @endif">{{ old('input.id.description') }}</textarea>
                                ...
                                <div class="tab-pane" id="enTab" role="tabpanel">
                                    <div class="row mt-5">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Description</label>
                                            <textarea name="input[en][description]" rows="5" class="form-control @if($errors->has('input.en.description')) is-invalid @endif">{{ old('input.en.description') }}</textarea>
