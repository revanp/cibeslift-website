            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">List Company Vision</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{ url('admin-cms/content/home/company-vision/create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <script>
        $(document).ready(function(){
            $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ url('admin-cms/content/home/company-vision/datatable') }}",
                    type: "POST",
                    data: {
                        "_token": "{{ csrf_token() }}"
                    }
        ...
        $(document).on('change', '.btn-activate', function(e){
            ...
            $.ajax({
                url: "{{ url('admin-cms/content/home/company-vision/change-status') }}",
                type: 'POST',
                dataType: 'json',
                data: {
                    _method: 'put',
